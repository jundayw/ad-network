        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('DummyViewRouteClass.list') }}" class="form-horizontal" method="get">
                        ...
                        <div class="panel-footer">
                            <div class="offset-md-1">
                                ...
                                <a class="btn btn-default btn-outline" href="{{ route('DummyViewRouteClass.list') }}">重置</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-action">
                        <div class="btn-group">
                            @policy('DummyViewRouteClass.create')
                            <a class="btn btn-default btn-outline" href="{{ route('DummyViewRouteClass.create') }}">
                                    ...
                                    @foreach($data as $items)
                                        <tr>
                                            ...
                                            <td class="text-center text-nowrap">
                                                @policy('DummyViewRouteClass.edit')
                                                <a href="{{ $items->edit }}" data-toggle="tooltip" data-original-title="编辑">编辑</a>
                                                @endpolicy
                                                @policy('DummyViewRouteClass.destroy')
