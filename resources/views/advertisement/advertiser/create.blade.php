        ...
        <div class="col-md-12">
            <div class="panel panel-success">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('advertisement.advertiser.store') }}" class="form-horizontal" method="post" rel-action="submit">
                        <div class="panel-body p-b-0">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name="usernick" value="" placeholder="请输入昵称" autocomplete="off">
                                </div>
                            </div>
                            <div class="form-group row">
