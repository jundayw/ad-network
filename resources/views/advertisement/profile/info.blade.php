                    ...
                    <form action="{{ route('advertisement.profile.info') }}" class="form-horizontal" method="post" rel-action="submit">
                        <div class="panel-body p-b-0">
                            ...
                            <div class="form-group row" rel-action="viewer" preview>
                                ...
                                <div class="col-md-10">
                                    <a href="javascript:void(0);">
                                        <img src="{{ $data->advertisement->licence_image }}" style="max-height:200px;" class="img-responsive thumbnail m-b-0">
                                    </a>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <select class="form-control" name="wallet" rel-action="select">
                                        @foreach($data->advertisement->getWallet() as $key => $wallet)
                                            <option value="{{ $key }}" @selected($key == $data->advertisement->wallet)>{{ $wallet }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" name="acount" value="{{ $data->advertisement->acount }}" placeholder="请输入钱包地址" autocomplete="off">
                                </div>
                            </div>
                        </div>
