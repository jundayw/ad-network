        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part">
                    <a class="logo" href="{{ route('advertisement.index') }}">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li class="dropdown">
                        <a class="waves-effect waves-light" href="{{ route('advertisement.clear') }}" rel-action="confirm" rel-certain="清除缓存" rel-msg="确定清除缓存">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
                                <a href="{{ route('advertisement.profile.password') }}">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    @endforeach
                    <li>
                        <a href="{{ route('advertisement.logout') }}" class="waves-effect">
