        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('advertisement.deposit.list') }}" class="form-horizontal" method="get">
                        ...
                        <div class="panel-footer">
                            <div class="offset-md-1">
                                ...
                                <a class="btn btn-default btn-outline" href="{{ route('advertisement.deposit.list') }}">重置</a>
                            </div>
                        </div>
                    </form>
                </div>
