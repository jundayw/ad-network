        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('advertisement.element.list') }}" class="form-horizontal" method="get">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" name="program" rel-action="select">
                                        ...
                                        @foreach($filter['program'] as $key => $program)
                                            <option value="{{ $program->id }}" @selected($program->id == $request->get('program'))>{{ $program->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="panel-footer">
                            <div class="offset-md-1">
                                ...
                                <a class="btn btn-default btn-outline" href="{{ route('advertisement.element.list') }}">重置</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-action">
                        <div class="btn-group">
                            @policy('advertisement.element.create')
                            <a class="btn btn-default btn-outline" href="{{ route('advertisement.element.create') }}">
                                    ...
                                    @foreach($data as $items)
                                        <tr>
                                            ...
                                            <td class="text-center text-nowrap">
                                                ...
                                                @endpolicy
                                                @policy('advertisement.element.destroy')
