        ...
        <div class="col-md-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('backend.size.update') }}" class="form-horizontal" method="post" rel-action="submit">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="width" value="{{ $data->width }}" placeholder="请输入宽度" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="text" name="height" value="{{ $data->height }}" placeholder="请输入高度" autocomplete="off">
                                        <span class="input-group-addon">px</span>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="checkbox-list">
                                        @foreach($filter['device'] as $key => $device)
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="device[]" value="{{ $key }}" @checked(in_array($key, $data->device))>
                                                {{ $device }}
                                            </label>
                                        @endforeach
                                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="checkbox-list">
                                        @foreach($filter['type'] as $key => $type)
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="type[]" value="{{ $key }}" @checked(in_array($key, $data->type))>
                                                {{ $type }}
                                            </label>
                                        @endforeach
                                    </div>
