        ...
        <div class="col-md-12">
            <div class="panel panel-danger">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('backend.site.update') }}" class="form-horizontal" method="post" rel-action="submit">
                        <div class="panel-body p-b-0">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2 control-label col-form-label">网址</label>
                                <div class="col-md-10">
                                    <p class="form-control-static">
                                        <a href="{{$data->protocol}}{{ $data->domain }}" target="_blank">
