        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('backend.publishment.list') }}" class="form-horizontal" method="get">
                        ...
                        <div class="panel-footer">
                            <div class="offset-md-1">
                                ...
                                <a class="btn btn-default btn-outline" href="{{ route('backend.publishment.list') }}">重置</a>
                            </div>
                        </div>
                    </form>
                </div>
                                    ...
                                    @foreach($data as $items)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('backend.deposit.create', ['type' => 'publishment', 'id' => $items->id]) }}" rel-action="dialog" rel-height="510" title="资金管理">
                                                    资金管理
                                                </a>
                                            </td>
                                            @endpolicy
                                            <td class="text-center text-nowrap">
                                                @policy('backend.publishment.edit')
                                                <a href="{{ $items->edit }}" data-toggle="tooltip" data-original-title="编辑">编辑</a>
                                                @endpolicy
                                                @policy('backend.publishment.destroy')
