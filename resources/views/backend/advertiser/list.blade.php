        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('backend.advertiser.list') }}" class="form-horizontal" method="get">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" name="role" rel-action="select">
                                        ...
                                        @foreach($filter['roles'] as $key => $role)
                                            <option value="{{ $role->id }}" @selected($role->id == $request->get('role'))>{{ $role->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="panel-footer">
                            <div class="offset-md-1">
                                ...
                                <a class="btn btn-default btn-outline" href="{{ route('backend.advertiser.list') }}">重置</a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                @if($data->isEmpty()===false)
                                    ...
                                    @foreach($data as $items)
                                        <tr>
                                            ...
                                            <td>{{ $items->advertisement->name }}</td>
