...
@section('content')
        ...
        <div class="col-md-3 col-sm-6">
            <div class="white-box">
                <div class="r-icon-stats">
                    ...
                    <div class="bodystate">
                        <h4>{{ $data['publishment']->getAttribute('total') }}</h4>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="white-box">
                <div class="r-icon-stats">
                    ...
                    <div class="bodystate">
                        <h4>{{ $data['publishment']->getAttribute('balance') }}</h4>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="white-box">
                <div class="r-icon-stats">
                    ...
                    <div class="bodystate">
                        <h4>{{ $data['publishment']->getAttribute('frozen') }}</h4>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="white-box">
                <div class="r-icon-stats">
                    ...
                    <div class="bodystate">
                        <h4>{{ $data['publishment']->getAttribute('weight') }}</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box">
                <h3 class="box-title">近七日广告收入分布</h3>
