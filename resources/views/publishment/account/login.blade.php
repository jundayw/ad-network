...
@section('main')
    ...
    <section id="wrapper" class="login-register">
        <div class="login-box">
            <div class="white-box">
                <form action="{{ route('publishment.verify') }}" class="form-horizontal form-material" method="post" rel-action="submit">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{{ route('publishment.signup') }}" class="text-dark pull-right">
                                注册
                            </a>
                        </div>
                    </div>
