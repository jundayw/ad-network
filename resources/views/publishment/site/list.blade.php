        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-wrapper">
                    <form action="{{ route('publishment.site.list') }}" class="form-horizontal" method="get">
                        ...
                        <div class="panel-footer">
                            <div class="offset-md-1">
                                ...
                                <a class="btn btn-default btn-outline" href="{{ route('publishment.site.list') }}">重置</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="panel-action">
                        <div class="btn-group">
                            @policy('publishment.site.create')
                            <a class="btn btn-default btn-outline" href="{{ route('publishment.site.create') }}">
