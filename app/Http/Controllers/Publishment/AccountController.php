...
use App\Http\Requests\Publishment\AccountLoginRequest;
use App\Http\Requests\Publishment\AccountMailRequest;
use App\Http\Requests\Publishment\AccountRegisterRequest;
use App\Http\Responses\RedirectResponse;
use App\Http\Responses\RenderResponse;
use App\Http\Responses\ViewResponse;
use App\Repositories\Publishment\AccountRepository;
...
class AccountController extends UnCommonController
{
    ...
    public function verify(AccountLoginRequest $request): RedirectResponse
    {
        ...
        return new RedirectResponse('操作成功', route('publishment.index'));
    }
    ...
    public function logout(Request $request): RedirectResponse
    {
        ...
        return new RedirectResponse('安全退出', route('publishment.login', ['code' => '100']));
    }
    ...
    public function register(AccountRegisterRequest $request): RedirectResponse
    {
        ...
        return new RedirectResponse('注册成功', route('publishment.login', ['code' => '200']));
    }
