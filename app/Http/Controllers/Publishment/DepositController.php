...
use App\Http\Requests\Publishment\DepositRechargeRequest;
use App\Http\Requests\Publishment\DepositWithdrawRequest;
use App\Http\Responses\RenderResponse;
use App\Http\Responses\ViewResponse;
use App\Repositories\Publishment\DepositRepository;
...
class DepositController extends AuthController
{
    ...
    public function store(DepositRechargeRequest $request): RenderResponse
    {
        ...
        return new RenderResponse('操作成功', route('publishment.deposit.list'));
    }
